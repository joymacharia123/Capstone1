import './index.css'
import Person1 from '../../assets/person-1.avif'
import Person2 from '../../assets/person-2.avif'
    ...
    return(
        ...
        <section>
            ...
            <div className='person-4'>
                <div className='text-2'>"Meraki is my go-to spot for date nights, and it never disappoints! The cozy yet elegant atmosphere sets the stage for a romantic evening, and the food is always exceptional. We love trying new dishes from their ever-changing menu, and we're never disappointed. The staff are always friendly and attentive, making us feel right at home. If you're looking for a memorable dining experience, look no further than Meraki!" - Alex M.</div>
                <div>
                    <img className='image-2' src={Person4}></img>
                </div>
            </div>
            <div className='person-5'>
                <div className='text-2'>"I recently had the pleasure of dining at Meraki with my family, and it was truly a culinary journey. The menu offered a fantastic variety of options, making it easy to cater to everyone's tastes. The food was beautifully presented and tasted even better than it looked. The service was impeccable - our server was knowledgeable and attentive, ensuring that we had everything we needed throughout the meal. Meraki exceeded all of our expectations, and we can't wait to return!" - Jessica W.</div>
                <div>
